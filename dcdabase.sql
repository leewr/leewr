...
INSERT INTO `article` VALUES ('2018-09-09 11:34:12', '12', '友情链接', '<p><a href=\"https://hecang.net\" target=\"_blank\">何仓博客</a></p>', 'article', '4', '2018-08-19 22:40:17', '26', null, '何仓博客', '0', '0');
...
INSERT INTO `article` VALUES ('2018-09-09 11:41:41', '34', '关于我们', '<h4>锐度，一场关于自我成长、自我阅读的实验田。</h4><h5>2018-09-09 文润</h5>', 'article', '4', '2018-08-19 22:40:17', '29', null, '锐度，一场关于自我成长、自我阅读的实验田', '0', '0');
...
INSERT INTO `article` VALUES (null, '15', '新用户文章', '<p>顶顶顶顶顶</p>', 'article', '1', '2018-08-19 22:40:17', '33', null, null, '0', '0');
...
INSERT INTO `article` VALUES ('2018-08-24 17:13:11', '86', '无标题读取内容AA1111啊   阿什顿发', '<p>需要注意的是：<strong>从编辑器中获取的 html 代码是不包含任何样式的纯 html</strong>，如果显示的时候需要对其中的<code>&lt;table&gt;</code><code>&lt;code&gt;</code><code>&lt;blockquote&gt;</code>等标签进行自定义样式（这样既可实现多皮肤功能），下面提供了编辑器中使用的样式供参考\r\n\r\n</p><p><br></p><p>asdfasdf</p>', 'article', '1', '2018-08-19 22:59:08', '37', null, '需要注意的是：从编辑器中获取的 html', '0', '1');
...
INSERT INTO `article` VALUES ('2018-09-11 15:51:24', '28', 'Git对某个文件的回退', '<h4>1、 查找文件</h4><p>gitcmd 环境下 find -name 文件名 找到文件完整路径</p><h4>2、查看要回退文件的历史记录</h4><p>命令： git log --oneline .a.txt</p><h4>3、使用 reset 命令</h4><p>命令： git reset 120a893 a.txt</p><h4>4、提交历史版本内容</h4><p>这个时候查看文件还是没有改动，因为这个文件目前的状态是 modify\r\n\r\n</p><p>命令： git commit -m&nbsp; \'reset file xxxx\'</p><h4>5、将文件xxxx切换到工作区</h4><p>命令： git checkout&nbsp; xxxx（执行这个操作前，也可以使用 git stash 备份一下）</p><p><br></p><p><br></p>', 'article', '1', '2018-08-24 17:25:40', '40', null, '1、 查找文件gitcmd 环境下 fi', '0', '1');
INSERT INTO `article` VALUES ('2018-09-01 12:10:55', '13', '出路', '<p>“真正的出路不在于要离开哪里，而是在于我们的内心是否对自身所处的这个文化有觉察和反省，并做出不一样的选择。”&nbsp;\r\n\r\n</p>', 'article', '1', '2018-08-24 17:26:10', '41', null, '“真正的出路不在于要离开哪里，而是在于我', '0', '0');
INSERT INTO `article` VALUES ('2018-08-28 15:08:32', '289', '重读经典，终将面对不期而遇的变化', '<div><div><p>01<br></p><p>再次拾起《谁动了我的奶酪》，我依然坐在飞逝的列车上，看着窗外飞速变换的风景，也许在冥冥中昭示着即将到来的改变。<br></p><p>这个风靡全球的故事，早已在大家心中留下了深深的印记，但重读起来，依然那样引人入胜。<br></p><p>故事从很久以前，遥远的地方展开，两只叫嗅嗅和匆匆的小老鼠，与两个叫哼哼和唧唧的小矮人住在一起，过着寻找奶酪、享受乐趣的生活。<br></p><p>有一天，他们找到了一个很大的奶酪站，小老鼠依然保持着一贯的状态；而小矮人却一天天开始享受、架构、习惯这样的生活，直到认为本该如此，也该一直如此。<br></p><p>直到有一天，奶酪站的奶酪没了，精彩便由此展开。<br></p><p>发现变化的小老鼠，问题和答案同样简单，取下挂在脖子上的跑鞋，穿上鞋子，系好鞋带，出发寻找新的奶酪。<br></p><p>而发现变化的小矮人，愤怒、咆哮、痛苦、挫败、逃避而不愿意面对现实，于是选择了被动的等待。<br></p><p>直到等了很久，发现到底等不到了，唧唧决定重返迷宫寻找奶酪，而哼哼依然如故。<br></p><p>重返迷宫是艰难的，最大的艰难却不是来自身体，而是内心的压力。<br></p><p>但毕竟迈出了这一步，最终唧唧也找到了新的更好的更大的奶酪站，并把图中的感悟写到了墙上，鼓励自己、启迪哼哼。<br></p><p>02<br></p><p>故事简单直接，道理也不复杂，却揭示了如何面对变化的有效武器。<br></p><p>面对变化的主题是人，而不是其他什么动物。倘若是老鼠，倒也简单，只能因变而变。但恰恰是人，作为一个复杂的组合体，都有其简单的一面和复杂的一面，才变得复杂而纠结。<br></p><p>有时候，我们像及时发现变化的嗅嗅；有时候，我们又像立即采取行动的匆匆；但大多数时候，我们更像抵制变化的哼哼和最终适应变化的唧唧。<br></p><p>但，无论我们像谁，那都是我们自己，又都不是我们自己，我们就是一个复杂的组合体，复杂到我们自己也搞不懂自己。<br></p><p>但，变化总是不期而遇，无论你愿不愿意，奶酪总会被人拿走，无论主动还是被动，最终总要面对。这时候，我们更需要的是如何面对变化的方法论。<br></p><p>03<br></p><p>也许你已经猜到了，这套方法论正是写在奶酪墙上的话。<br></p><p>①保持平常心，变化总会发生，正如一个地方的奶酪总会消失的，无论是变质了、吃光了，还是被人拿走了。<br></p><p>②学会预测变化，经常看一看、查一查、嗅一嗅，做好随时失去奶酪的准备。<br></p><p>③正确面对变化，发生了就是发生了，可以埋怨，可以愤怒，但不能一直埋怨、一直愤怒。<br></p><p>④迅速适应变化，越早放弃旧的奶酪，便越早可能享受新的奶酪。<br></p><p>⑤尽情享受变化，感受一路寻找的风景，感受新奶酪带来的美味。<br></p><p>当然，变化永远没有终结，当享受新的奶酪之时，新的变化正悄悄而来。<br></p><p>04<br></p><p>道理似乎简单到不值一提，套路似乎简单到不堪一击，但从来都是知易行难。<br></p><p>当我们真正面对变化的奶酪时，我们并不一定比两个小老鼠表现的出色，甚至连不肯面对变化的哼哼都不如。<br></p><p>正如故事中的唧唧一般，从否认变化，到决定面对变化，再到最终适应变化并享受变化，是经历了相当艰难的心理历程，往往心中滋生的恐惧比现实的情况更加麻烦。<br></p><p>在这中间，还有两个法宝。<b>一个是不停的构建愿景，想象变化之后的种种美好，越具体、越详细、越色彩斑斓越好。另一个是不断的自我解嘲，越是嘲笑自己的愚蠢，越能对自己的过去释然，越能更好的向着新方向前进。</b><br></p><p>当然，也许像小老鼠一样，不管三七二十一，迈出第一步再说；但，我们毕竟不是老鼠，我们的奶酪如果是爱情、事业、甚至是人生的话，我们也不得不十分慎重。<br></p><p>又当然，如果我们能够不仅仅做一个变化的适应者，而成为变化的引领者，甚至是设计者的话，那所有的变化都将是美好的历程。</p></div><br><br>作者：王梦凡<br>链接：https://www.jianshu.com/p/75092390f7c0<br>來源：简书<br>简书著作权归作者所有，任何形式的转载都请联系作者获得授权并注明出处。</div>', 'article', '1', '2018-08-27 19:35:31', '42', null, '01再次拾起《谁动了我的奶酪》，我依然坐', '1', '2');
INSERT INTO `article` VALUES (null, '1', 'nginx 服务器安装 yum 和 源码包安装', '<h2>yum 和 源码包 安装的区别</h2><p>nginx 可以通过yum -y install nginx 的方式安装源码包。</p><p>源码包的方式是先将nginx的源码下载下来，在自己的系统里编译生成可执行文件，然后执行。好处符合自己系统的性能。缺点麻烦。</p><h3>安装路径不同</h3><p>yum 在线安装会将nginx的安装文件放在系统的不同位置，可以通过&nbsp;<span style=\"background-color: rgb(241, 241, 241);\">rmp - ql nginx</span></p><p>来查看安装路径。</p><p>删除的时候，只能通过命令来删除，因为我们不可能将这些文件自己手动删除。可以通过&nbsp;<span style=\"background-color: rgb(241, 241, 241);\">rpm -e nginx</span></p><p>来删除。如果提示依赖包的问题，可以尝试&nbsp;<span style=\"background-color: rgb(241, 241, 241);\">rpm -e --nodeps nginx</span></p><p>来删除。</p><p><span style=\"font-weight: bold;\">源码包 </span>安装他的所有文件都在同一个目录下，删除的时候可以直接将文件夹删除。因此不会存在垃圾文件。</p><h3>启动方式不同</h3><p><span style=\"font-weight: bold;\">yum</span> 安装 nginx， 我们可以通过系统服务 service 来启动或停止</p><pre><code>service nginx start #启动 nginx 服务<br>service nginx stop #停止 nginx 服务<br>service nginx restart #重启 nginx 服务</code></pre><p>源码包安装nginx启动的时候不能使用service来启东，需要 nginx 安装目录下的 sbin 目录下的nginx 可执行程序才行。</p><pre><code>~ /usr/local/webserver/nginx/sbin/nginx           #启动 nginx 服务<br> ~ /usr/local/webserver/nginx/sbin/nginx -s stop   #停止 nginx 服务</code></pre><p>注意：</p><p>在自己的系统中只用选择一种安装方式即可，yum 安装的 nginx 版本可能不是最新的，可以通过 源码包 安装最新的，但系统中只要一种就可以，如果你想安装两个安装也可以，但是他们监听的端口都是 80 端口，每次只能启动一个\r\n\r\n</p><p><br></p><p><br></p><p>源码包方式省略&nbsp;</p><p>参考文档&nbsp;<a href=\"https://segmentfault.com/a/1190000007116797\" target=\"_blank\">https://segmentfault.com/a/1190000007116797</a></p>', 'article', '5', '2018-09-13 22:55:04', '43', null, 'yum 和 源码包 安装的区别nginx', '0', '0');
INSERT INTO `article` VALUES (null, '1', 'linux 下删除文件、文件夹', '<h3>rm -rf 目录名字 即可</h3><p>-r 就是向下递归，不管多少级目录，并删除</p><p>-f 就是直接强行删除，不做任何提示的意思</p><p><br></p><p>eg:</p><p>删除文件夹实例：rm -rf /var/log/httpd/access<br>将会删除/var/log/httpd/access目录以及其下所有文件、文件夹</p><p>删除文件使用实例：rm -f /var/log/httpd/access.log<br>将会强制删除/var/log/httpd/access.log这个文件</p><p><br></p>', 'article', '5', '2018-09-13 23:16:40', '44', null, 'rm -rf 目录名字 即可-r 就是向', '0', '0');
INSERT INTO `article` VALUES (null, '1', 'linux 通过nvm安装node', '<h2 id=\"linux-安装-nvm\">linux 安装 nvm</h2><pre><code>wget -qO- https://raw.githubusercontent.com/creationix/nvm/v0.31.1/install.sh | bash</code></pre><p>或者</p><pre><code>curl -o- https://raw.githubusercontent.com/creationix/nvm/v0.31.1/install.sh | bash</code></pre><p>然后</p><pre name=\"code\"><code>source ~/.bashrc</code><ul></ul></pre><p>安装node</p><pre><code>nvm install stable</code></pre><h3 id=\"nvm切换版本\"><br></h3><h3 id=\"nvm切换版本\">nvm切换版本</h3><p>暂未涉及到忽略</p>', 'article', '5', '2018-09-13 23:24:10', '45', null, 'linux 安装 nvmwget -qO', '0', '0');
INSERT INTO `article` VALUES (null, '1', 'linux 源码、yum安装git 服务', '<pre><code>make&nbsp;configure </code></pre><div><strong>5、make configure</strong></div><div>如果报错/bin/sh: autoconf: command not found：</div><div>安装libtool即可：yum install install autoconf automake libtool</div><div>正常会打印：GEN configure</div><p>6、</p><p>参考文章：</p><p><a href=\"http://blog.51cto.com/13505030/2055144\" target=\"_blank\">http://blog.51cto.com/13505030/2055144</a></p>', 'article', '5', '2018-09-14 00:29:14', '46', null, 'make&nbsp;configure ', '0', '0');
...
INSERT INTO `comment` VALUES ('2', '1001001001', '', '4', '42', '新增第二条评论', '1', '0', '2018-09-10 17:25:23', '2018-09-10 17:25:23');
INSERT INTO `comment` VALUES ('3', '101001001', 'admin1', '4', '42', '去11 ', '1', '0', '2018-09-10 17:36:17', '2018-09-10 17:36:17');
INSERT INTO `comment` VALUES ('4', '10010001', 'admin1', '4', '42', '阿什顿发', '1', '0', '2018-09-10 17:37:36', '2018-09-10 17:37:36');
INSERT INTO `comment` VALUES ('5', '1001001101', 'admin1', '4', '42', '阿什顿发洒洒水', '1', '0', '2018-09-10 17:37:42', '2018-09-10 17:37:42');
INSERT INTO `comment` VALUES ('6', '1101000001', 'admin1', '4', '42', '少时诵诗书', '1', '0', '2018-09-10 17:37:46', '2018-09-10 17:37:46');
INSERT INTO `comment` VALUES ('7', '1000111111', 'admin1', '4', '42', '少时诵诗书洒洒水', '1', '0', '2018-09-10 17:37:49', '2018-09-10 17:37:49');
