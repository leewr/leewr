...
INSERT INTO `article` VALUES ('2018-08-24 17:13:11', '76', '无标题读取内容AA1111啊   阿什顿发', '<p>需要注意的是：<strong>从编辑器中获取的 html 代码是不包含任何样式的纯 html</strong>，如果显示的时候需要对其中的<code>&lt;table&gt;</code><code>&lt;code&gt;</code><code>&lt;blockquote&gt;</code>等标签进行自定义样式（这样既可实现多皮肤功能），下面提供了编辑器中使用的样式供参考\r\n\r\n</p><p><br></p><p>asdfasdf</p>', 'article', '1', '2018-08-19 22:59:08', '37', null, '需要注意的是：从编辑器中获取的 html', '0', '1');
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('7', 'leewr', '1', 'leewr', '$2a$10$TfBbLxUZf4brbZNmBFrZv.vhf0PmcnXKlUkNbAWREtacV1EEYmZp6', '1', '1111', '0', '1', '1', '0');
INSERT INTO `user` VALUES ('32', 'admin1', '4', 'admin1', '$2a$10$TfBbLxUZf4brbZNmBFrZv.vhf0PmcnXKlUkNbAWREtacV1EEYmZp6', '1', '', '3', '0', '1', '0');
INSERT INTO `user` VALUES ('0', 'admin', '3', 'admin', '123456', '1', '', '0', '1', '0', '0');
INSERT INTO `user` VALUES ('1', 'leewr1', '5', 'leewr1', '$2a$10$PKD/rRiOvEOV6QXLnXV3S.17YgALFLw.Z23KVz3Vul.xNWjFQECCK', '1', '', '0', '0', '0', '0');
